...
/**
 * Class ShortCodeTransactionTable
 *
 * @package FMDataAPI
 */
class ShortCodeTransactionsTable extends ShortCodeBase
{
    /**
    ...
    public function __construct(FileMakerDataAPI $api, Settings $settings)
    {
        ...
        add_shortcode('FM-DATA-TRANSACTIONS-TABLE', [$this, 'retrieveTableContent']);
    }
